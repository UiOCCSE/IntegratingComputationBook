...
possible learning outcomes which could be applied to a bachelor's degree
...
are thence discussed in section \ref{sec:examples}.
Finally, in the last section we present our conclusions and perspectives.


\section{Computing competences} \label{sec:competences}
...
education. Furthermore, we give our students the competences which are
